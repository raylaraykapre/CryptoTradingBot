...
tk.Label(button_frame, text="Trading Bot").grid(row=0, column=0, columnspan=3, pady=5)
...
signature_label = tk.Label(log_frame, text="beaver", font=("Arial", 8), fg="gray")
signature_label.pack(anchor=tk.SE, padx=5, pady=5)
